...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-black/40 backdrop-blur-sm md:${
      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/service-desk" className="nav-link text-white font-semibold">Service Desk</Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-black/95 backdrop-blur-md shadow-lg py-4">
            <div className="flex flex-col space-y-4 px-6">
              ...
              <Link to="/service-desk" className="nav-link text-white font-semibold" onClick={() => setIsMenuOpen(false)}>Service Desk</Link>
